...
//
//////////////////////////////////////////////////////////////////////////
void CTriangle::Init(SFloat32Vec3* psPoint1, SFloat32Vec3* psPoint2, SFloat32Vec3* psPoint3, SFloat32Vec3* psNormal)
{
...
//
//////////////////////////////////////////////////////////////////////////
void CTriangle::Set(SFloat32Vec3* psPoint1, SFloat32Vec3* psPoint2, SFloat32Vec3* psPoint3)
{
...
//
//////////////////////////////////////////////////////////////////////////
void CTriangle::Set(float32 x1, float32 y1, float32 z1, float32 x2, float32 y2, float32 z2, float32 x3, float32 y3, float32 z3)
{
...
//
//////////////////////////////////////////////////////////////////////////
SFloat32Vec3* CTriangle::GetPoint(size iPoint)
{
	if (iPoint == 0)
	{
		return mpsPosition;
...
//
//////////////////////////////////////////////////////////////////////////
bool CTriangle::HasPositionPtr(SFloat32Vec3* psPosition)
{
...
//
//////////////////////////////////////////////////////////////////////////
void CTriangle::Center(SFloat32Vec3* psCenter)
{
...
//
//////////////////////////////////////////////////////////////////////////
void CTriangle::GetEdgeDirections(SFloat32Vec3* psEdge1, SFloat32Vec3* psEdge2, SFloat32Vec3* psEdge3)
{
...
//
//////////////////////////////////////////////////////////////////////////
void CTriangle::GetAngles(float32* psAngle0, float32* psAngle1, float32* psAngle2)
{
	SFloat32Vec3	sSide1;
	SFloat32Vec3	sSide2;
	SFloat32Vec3	sSide3;
...
//
//////////////////////////////////////////////////////////////////////////
size CTriangle::IsSliver(float32 fAngleSliver, SFloat32Vec3** pps0, SFloat32Vec3** pps1, SFloat32Vec3** pps2)
{
	float32	fAngle0;
	float32	fAngle1;
	float32	fAngle2;
