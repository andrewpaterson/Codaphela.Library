...
typedef voidpf (*alloc_func) OF((voidpf opaque, uint32 items, uint32 size));
...
ZEXTERN uint32 ZEXPORT deflateBound OF((z_streamp strm,
                                       uint32 sourceLen));
/*
...
ZEXTERN uint32 ZEXPORT zlibCompileFlags OF((void));
...
ZEXTERN int ZEXPORT compress OF((uint8 *dest,   uint32 *destLen,
...
ZEXTERN int ZEXPORT compress2 OF((uint8 *dest,   uint32 *destLen,
                                  const uint8 *source, uint32 sourceLen,
                                  int level));
/*
...
ZEXTERN uint32 ZEXPORT compressBound OF((uint32 sourceLen));
/*
...
ZEXTERN int ZEXPORT uncompress OF((uint8 *dest,   uint32 *destLen,
                                   const uint8 *source, uint32 sourceLen));
/*
...
ZEXTERN uint32 ZEXPORT adler32 OF((uint32 adler, const uint8 *buf, uint32 len));
/*
...
ZEXTERN uint32 ZEXPORT adler32_combine OF((uint32 adler1, uint32 adler2,
                                          z_off_t len2));
/*
...
ZEXTERN uint32 ZEXPORT crc32   OF((uint32 crc, const uint8 *buf, uint32 len));
/*
...
ZEXTERN uint32 ZEXPORT crc32_combine OF((uint32 crc1, uint32 crc2, z_off_t len2));
...
ZEXTERN const uint32 * ZEXPORT get_crc_table    OF((void));
