...
void CInstructionFactory::CreateInstructions(void)
{
    ...
    mapcInstructions[6] = CreateINC_A(INC_Accumulator, CreateAccumulatorCycles(&CW65C816::INC_A));
    ...
    mapcInstructions[8] = CreateDEC_A(DEC_Accumulator, CreateAccumulatorCycles(&CW65C816::DEC_A));
