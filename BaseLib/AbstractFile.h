...
public:
	...
	virtual int		Read(void* pvBuffer, int iSize, int iCount) = 0;
	virtual int		Seek(filePos iOffset, int iSeekOrigin) = 0;
	virtual int		Write(const void* pvBuffer, int iSize, int iCount) = 0;
