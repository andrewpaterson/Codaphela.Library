...
//
//////////////////////////////////////////////////////////////////////////
void STypedPointer::Init(void* pvData, int iType)
{
	this->pvData = pvData;
	this->iType = iType;
}
...
int UnknownTypeGetType(void* pvData)
{
	...
	if (pvData == NULL)
	{
		gcUserError.Set("Can't get unknown type type from NULL");
		return -1;
	}
	pv = (SUnknownType*)RemapSinglePointer(pvData, -((int)sizeof(SUnknownType)));
	return pv->miType;
}
...
int UnknownTypeGetSize(void* pvData)
{
	...
	if (pvData == NULL)
	{
		gcUserError.Set("Can't get unknown type size from NULL");
		return -1;
	}
	pv = (SUnknownType*)RemapSinglePointer(pvData, -((int)sizeof(SUnknownType)));
	return pv->miSize;
...
void UnknownTypeFree(void* pvData)
{
	...
	if (pvData == NULL)
	{
		gcUserError.Set("Can't free NULL unknown type");
		return;
	}
	pv = (SUnknownType*)RemapSinglePointer(pvData, -((int)sizeof(SUnknownType)));
	free(pv);
