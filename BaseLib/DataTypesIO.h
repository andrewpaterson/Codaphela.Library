...
DATA_TYPE_IO_DEFINITION(SIOInt8, int8, WriteInt8, ReadInt8)
DATA_TYPE_IO_DEFINITION(SIOInt16, int16, WriteInt16, ReadInt16)
DATA_TYPE_IO_DEFINITION(SIOInt32, int32, WriteInt32, ReadInt32)
DATA_TYPE_IO_DEFINITION(SIOInt64, int64, WriteInt64, ReadInt64)
DATA_TYPE_IO_DEFINITION(SIOUInt8, uint8, WriteInt8, ReadInt8)
DATA_TYPE_IO_DEFINITION(SIOUInt16, uint16, WriteInt16, ReadInt16)
DATA_TYPE_IO_DEFINITION(SIOUInt32, uint32, WriteInt32, ReadInt32)
DATA_TYPE_IO_DEFINITION(SIOUInt64, uint64, WriteInt64, ReadInt64)
