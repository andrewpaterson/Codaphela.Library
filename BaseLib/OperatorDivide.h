...
typedef void	(* OperatorDivideFunc)		(void* pvDest, void* pvLeft, void* pvRight);


class COperatorDivide
{
public:
	OperatorDivideFunc mapvDivide[PRIMTIVE_OPERATOR_END][PRIMTIVE_OPERATOR_END][PRIMTIVE_OPERATOR_END];
