...
{
	bool					bResult;
	CStackMemory<2 KB>		cStackSet;
	CStackMemory<2 KB>		cStackGet;
...
bool CNamedIndexedData::ValidateOidToNameToOid(void)
{
	...
	OIndex					oi;
	CStackMemory<2 KB>		cStackMemory;
	uint32					uiDataSize;
...
//
//////////////////////////////////////////////////////////////////////////
bool CNamedIndexedData::ValidateCache(void)
{
	return mcData.ValidateCache();
}
