...
//
//////////////////////////////////////////////////////////////////////////
TRISTATE CTypeParser::ParseFloat3(SFloat32Vec3* pDest, char cOpen, char cSplit, char cClose)
{
	TRISTATE	tResult;
...
//
//////////////////////////////////////////////////////////////////////////
TRISTATE CTypeParser::ParseFloat4(SFloat32Vec4* pDest, char cOpen, char cSplit, char cClose)
{
	TRISTATE	tResult;
...
//
//////////////////////////////////////////////////////////////////////////
TRISTATE CTypeParser::ParseInt3(SInt32Vec3* pDest, char cOpen, char cSplit, char cClose)
{
	TRISTATE	tResult;
...
TRISTATE CTypeParser::Parse(EPrimitiveType eType, void* pvDest, size iDestLength, char cOpen, char cSplit, char cClose)
{
	switch (eType)
	{
		...
		case PT_M3float32:
			...
			{
				return ParseFloat3((SFloat32Vec3*)pvDest);
			}
			break;
		case PT_M4float32:
			if (iDestLength >= FLOAT4_BYTE_SIZE)
			{
				return ParseFloat4((SFloat32Vec4*)pvDest);
			}
			break;
		case PT_M2int32:
		...
		case PT_M3int32:
			...
			{
				return ParseInt3((SInt32Vec3*)pvDest);
			}
			break;
		case PT_M4int32:
