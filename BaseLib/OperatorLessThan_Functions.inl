...
void LessThanUIntUInt(bool* pvDest, void* pvLeft, void* pvRight) { *pvDest = (bool)(*(uint32*)pvLeft < *(uint32*)pvRight); }
void LessThanUIntUShort(bool* pvDest, void* pvLeft, void* pvRight) { *pvDest = (bool)(*(uint32*)pvLeft < *(uint16*)pvRight); }
void LessThanUIntUChar(bool* pvDest, void* pvLeft, void* pvRight) { *pvDest = (bool)(*(uint32*)pvLeft < *(uint8*)pvRight); }
void LessThanUIntULong(bool* pvDest, void* pvLeft, void* pvRight) { *pvDest = (bool)(*(uint32*)pvLeft < *(uint64*)pvRight); }
void LessThanUShortUInt(bool* pvDest, void* pvLeft, void* pvRight) { *pvDest = (bool)(*(uint16*)pvLeft < *(uint32*)pvRight); }
void LessThanUShortUShort(bool* pvDest, void* pvLeft, void* pvRight) { *pvDest = (bool)(*(uint16*)pvLeft < *(uint16*)pvRight); }
void LessThanUShortUChar(bool* pvDest, void* pvLeft, void* pvRight) { *pvDest = (bool)(*(uint16*)pvLeft < *(uint8*)pvRight); }
void LessThanUShortULong(bool* pvDest, void* pvLeft, void* pvRight) { *pvDest = (bool)(*(uint16*)pvLeft < *(uint64*)pvRight); }
void LessThanUCharUInt(bool* pvDest, void* pvLeft, void* pvRight) { *pvDest = (bool)(*(uint8*)pvLeft < *(uint32*)pvRight); }
void LessThanUCharUShort(bool* pvDest, void* pvLeft, void* pvRight) { *pvDest = (bool)(*(uint8*)pvLeft < *(uint16*)pvRight); }
void LessThanUCharUChar(bool* pvDest, void* pvLeft, void* pvRight) { *pvDest = (bool)(*(uint8*)pvLeft < *(uint8*)pvRight); }
void LessThanUCharULong(bool* pvDest, void* pvLeft, void* pvRight) { *pvDest = (bool)(*(uint8*)pvLeft < *(uint64*)pvRight); }
...
void LessThanULongUInt(bool* pvDest, void* pvLeft, void* pvRight) { *pvDest = (bool)(*(uint64*)pvLeft < *(uint32*)pvRight); }
void LessThanULongUShort(bool* pvDest, void* pvLeft, void* pvRight) { *pvDest = (bool)(*(uint64*)pvLeft < *(uint16*)pvRight); }
void LessThanULongUChar(bool* pvDest, void* pvLeft, void* pvRight) { *pvDest = (bool)(*(uint64*)pvLeft < *(uint8*)pvRight); }
