...
typedef void	(* OperatorMultiplyFunc)		(void* pvDest, void* pvLeft, void* pvRight);


class COperatorMultiply
{
public:
	OperatorMultiplyFunc mapvMultiply[PRIMTIVE_OPERATOR_END][PRIMTIVE_OPERATOR_END][PRIMTIVE_OPERATOR_END];
