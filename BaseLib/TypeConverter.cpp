...
//
// To 'int8' Conversions.
SCALE_TRUNCATE_FLOAT_TO_SINT(float64, int8, MIN_INT8, MAX_INT8)
SCALE_TRUNCATE_FLOAT_TO_SINT(float32, int8, MIN_INT8, MAX_INT8)
SCALE_TRUNCATE_BIG_SINT_TO_SMALL_SINT(int64, int8, MAX_INT8, MAX_INT64)
SCALE_TRUNCATE_BIG_SINT_TO_SMALL_SINT(int32, int8, MAX_INT8, MAX_INT32)
SCALE_TRUNCATE_BIG_SINT_TO_SMALL_SINT(int16, int8, MAX_INT8, MAX_INT16)
SCALE_TRUNCATE_BIG_SINT_TO_SMALL_SINT(int8, int8, MAX_INT8, MAX_INT8)
SCALE_TRUNCATE_BIG_UINT_TO_SMALL_SINT(uint64, int8, MAX_INT8, MAX_INT64)
SCALE_TRUNCATE_BIG_UINT_TO_SMALL_SINT(uint32, int8, MAX_INT8, MAX_INT32)
SCALE_TRUNCATE_BIG_UINT_TO_SMALL_SINT(uint16, int8, MAX_INT8, MAX_INT16)
SCALE_TRUNCATE_BIG_UINT_TO_SMALL_SINT(uint8, int8, MAX_INT8, MAX_INT8)
SCALE_TRUNCATE_FLOAT_TO_UINT(float64, uint8, MIN_UINT8, MAX_UINT8)
SCALE_TRUNCATE_FLOAT_TO_UINT(float32, uint8, MIN_UINT8, MAX_UINT8)
SCALE_TRUNCATE_BIG_SINT_TO_SMALL_UINT(int64, uint8, MAX_INT8, MAX_INT64)
SCALE_TRUNCATE_BIG_SINT_TO_SMALL_UINT(int32, uint8, MAX_INT8, MAX_INT32)
SCALE_TRUNCATE_BIG_SINT_TO_SMALL_UINT(int16, uint8, MAX_INT8, MAX_INT16)
void ConvertScaleTruncate_int8_To_uint8(uint8* psDest,	int8* pi)	{ *psDest = *pi >= 0 ? (*pi * 2 + (*pi > 0x40 ? 1 : 0)) : 0; }
SCALE_TRUNCATE_BIG_UINT_TO_SMALL_UINT(uint64, uint8, MAX_INT8, MAX_INT64)
SCALE_TRUNCATE_BIG_UINT_TO_SMALL_UINT(uint32, uint8, MAX_INT8, MAX_INT32)
SCALE_TRUNCATE_BIG_UINT_TO_SMALL_UINT(uint16, uint8, MAX_INT8, MAX_INT16)
SCALE_TRUNCATE_BIG_UINT_TO_SMALL_UINT(uint8, uint8, MAX_INT8, MAX_INT8)
...
SCALE_TRUNCATE_FLOAT_TO_SINT(float64, int16, MIN_INT16, MAX_INT16)
SCALE_TRUNCATE_FLOAT_TO_SINT(float32, int16, MIN_INT16, MAX_INT16)
SCALE_TRUNCATE_BIG_SINT_TO_SMALL_SINT(int64, int16, MAX_INT16, MAX_INT64)
SCALE_TRUNCATE_BIG_SINT_TO_SMALL_SINT(int32, int16, MAX_INT16, MAX_INT32)
SCALE_TRUNCATE_BIG_SINT_TO_SMALL_SINT(int16, int16, MAX_INT16, MAX_INT16)
void ConvertScaleTruncate_int8_To_int16(int16* psDest, int8* pi) { *psDest = ((int16)*pi << 8) | *pi; }
SCALE_TRUNCATE_BIG_UINT_TO_SMALL_SINT(uint64, int16, MAX_INT16, MAX_INT64)
SCALE_TRUNCATE_BIG_UINT_TO_SMALL_SINT(uint32, int16, MAX_INT16, MAX_INT32)
SCALE_TRUNCATE_BIG_UINT_TO_SMALL_SINT(uint16, int16, MAX_INT16, MAX_INT16)
void ConvertScaleTruncate_uint8_To_int16(int16* psDest, uint8* pi) { *psDest = ((int16)*pi << 7) | *pi; }
SCALE_TRUNCATE_FLOAT_TO_UINT(float64, uint16, MIN_UINT16, MAX_UINT16)
SCALE_TRUNCATE_FLOAT_TO_UINT(float32, uint16, MIN_UINT16, MAX_UINT16)
SCALE_TRUNCATE_BIG_SINT_TO_SMALL_UINT(int64, uint16, MAX_INT16, MAX_INT64)
SCALE_TRUNCATE_BIG_SINT_TO_SMALL_UINT(int32, uint16, MAX_INT16, MAX_INT32)
...
SCALE_TRUNCATE_BIG_UINT_TO_SMALL_UINT(uint64, uint16, MAX_INT16, MAX_INT64)
SCALE_TRUNCATE_BIG_UINT_TO_SMALL_UINT(uint32, uint16, MAX_INT16, MAX_INT32)
