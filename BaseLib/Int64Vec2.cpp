...
//																		//
//////////////////////////////////////////////////////////////////////////
void SInt64Vec2::Print(CChars* psx, int iWholeNumbers)
{
	CChars	szzz;
	int		iWidth;
...
//																		//
//////////////////////////////////////////////////////////////////////////
int SInt64Vec2::WholeNumbers(void)
{
	int i[2];
...
//																		//
//////////////////////////////////////////////////////////////////////////
int64 Int64Vec2LengthSq(const SInt64Vec2 *pV)
{
...
{
	pOut->x = pV1->x + (int64)(s * (pV2->x - pV1->x));
	pOut->y = pV1->y + (int64)(s * (pV2->y - pV1->y));
	return pOut;
}
...
void Int64Vec2MinMax(SInt64Vec2* psMin, SInt64Vec2* psMax, SInt64Vec2* asIn, int iInStride, int iNumPoints)
{
	...
	if (iNumPoints > 0)
	{
		...
		*psMax = *psIn;
		...
		{
			psIn = (SInt64Vec2*)RemapSinglePointer(asIn, i * iInStride);
...
void Int64Vec2InterpolatePosition(SInt64Vec2* psVecDest, const SInt64Vec2* psVec1, const SInt64Vec2* psVec2, float32 fWeight)
{
	...
	Int64Vec2Scale(&sVec1, psVec1, fWeight);
	Int64Vec2Scale(&sVec2, psVec2, 1.0f - fWeight);
	Int64Vec2Add(psVecDest, &sVec1, &sVec2);
}
