...
{
	mcIndexTree.Init(pcController, pcConfig->GetSubDirectory(), pcConfig->GetIndexCacheSize(), pcConfig->GetIndexTreeEvictionCallback(), pcConfig->GetEvictionStrategy(), this, pcConfig->GetWriteThrough(), IKR_No);
}
