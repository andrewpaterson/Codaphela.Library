...
void PowerInvalid(void* pvDest, void* pvLeft, void* pvRight) { gcUserError.Set("Power not defined for types"); }
#include "OperatorPower_Functions.inl"
...
void COperatorPower::Init(void)
{
	...
	for (iDest = 0; iDest < PRIMTIVE_OPERATOR_END; iDest++)
	{
		for (iLeft = 0; iLeft < PRIMTIVE_OPERATOR_END; iLeft++)
		{
			...
			{
				mapvPower[iDest][iLeft][iRight] = PowerInvalid;
			}
		}
	}
#include "OperatorPower_Mapping.inl"
}
