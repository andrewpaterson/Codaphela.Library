...
void CIndexedData::Init(CDurableFileController* pcController, CIndexedDataConfig* pcConfig)
{
	...
	mcIndices.Init(this, mpcDurableFileControl, pcConfig->GetSubdirectory(), pcConfig->GetIndexCacheSize(), meWriteThrough, pcConfig->GetIndexTreeEvictionUserCallback());
