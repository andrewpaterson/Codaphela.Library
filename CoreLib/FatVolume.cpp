...
//
//////////////////////////////////////////////////////////////////////////
EFatCode CFatVolume::InitialiseAllocatedFatCluster(SFatRawDirectoryEntry* psParentDirectory, uint32 uiClusterIndexInTable, bool bZero)
{
	EFatCode	eResult;
...
//
//////////////////////////////////////////////////////////////////////////
EFatCode CFatVolume::Fat12IncreaseClusterAddress(uint32 uiClusterIndex, uint32* puiFirstClusterSector, uint32* puiOffsetInSector, bool* pbFat12OddClusterBeingProcessed, bool* pbFat12MultiStepProgress)
{
...
//
//////////////////////////////////////////////////////////////////////////
EFatCode CFatVolume::FatQueryNextEntry(SFatQueryState* psQuery, bool bBufferLocked, bool bFirstEntry)
{
	bool		bPass;
	...
	do
	{
		...
		if (!bFirstEntry)
		{
			if (((uintptr_t)psQuery->sCurrentEntryRaw - (uintptr_t)psQuery->sFirstEntryRaw) == GetSectorSize() - 0x20)
			{
				...
				if (psQuery->uiCurrentCluster > 0 &&/*psQuery->uiCurrentSector > 0x0 &&*/ psQuery->uiCurrentSector == GetNoOfSectorsPerCluster() - 1)
				{
					fatEntry uiFat;
