...
** ------------------------------------------------------------------------ **/
#ifndef __OPERATOR_NOT_EQUAL_H__
#define __OPERATOR_NOT_EQUAL_H__
...
{
public:
	OperatorNotEqualFunc mapvNotEqual[PRIMTIVE_OPERATOR_END][PRIMTIVE_OPERATOR_END];
...
#endif // !__OPERATOR_NOT_EQUAL_H__
