...
** ------------------------------------------------------------------------ **/
#ifndef __INPUT_CHORD_READER_H__
#define __INPUT_CHORD_READER_H__
#include "BaseLib/Markup.h"
#include "InputChordDesc.h"


class CAction;
class CInputChordDescs;
class CInputDeviceDesc;
class CInputChordReader
{
public:
	CInputChordDescs*	mpcInputChordDescs;
	CMarkupTag*			mpcParentTag;
	CInputDeviceDesc*	mpcDeviceDesc;
	CInputChordDesc*	mpcReadChordDesc;
