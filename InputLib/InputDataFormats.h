...
** ------------------------------------------------------------------------ **/
#ifndef __INPUT_DATA_FORMATS_H__
#define __INPUT_DATA_FORMATS_H__
...
public:
	...
	CInputDataFormat*	Add(char* szName);
	CInputDataFormat*	Add(void);
	CInputDataFormat*	Get(char* szName);
};
